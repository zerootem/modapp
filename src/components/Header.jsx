...
function Header() {
  return (
    <header>
      <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0.5rem 1.25rem', maxWidth:'64rem', margin:'0 auto'}}>
        <a href="https://www.modweeb.com" target="_blank" rel="noopener noreferrer" style={{display:'flex', alignItems:'center', gap:'0.75rem', color:'var(--mw-headC)', textDecoration:'none'}}>
          <div className="logo-box" style={{background:'var(--mw-contentB)', border:'1px solid var(--mw-contentL)', borderRadius:'8px', width:'36px', height:'36px', display:'flex', alignItems:'center', justifyContent:'center'}}>
            <svg viewBox="0 0 514 514" style={{width:'100%', height:'100%', transform:'scale(1.1)'}}>
          ...
          <span style={{fontSize:'1.125rem', fontWeight:500, color:'var(--mw-headC)'}}>By Modweeb</span>
        </a>
      </div>
    </header>
  );
